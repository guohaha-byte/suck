...
#define     ESP8266_CH_HIGH_LEVEL()             GPIO_SetBits( GPIOF, GPIO_Pin_6 )
#define     ESP8266_CH_LOW_LEVEL()              GPIO_ResetBits( GPIOF, GPIO_Pin_6 )

#define     ESP8266_RST_HIGH_LEVEL()            GPIO_SetBits( GPIOC, GPIO_Pin_0 )
#define     ESP8266_RST_LOW_LEVEL()             GPIO_ResetBits( GPIOC, GPIO_Pin_0 )
